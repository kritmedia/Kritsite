...
export const PRICING_PLANS: PricingPlan[] = [
  {
    ...
    usdPrice: '$179',
    period: 'launch price',
    description: 'The 48-hour signature catalog is currently in incubation. We are crafting 6 architectural frameworks to launch your business in 1–2 days without custom design delays. Pre-register for priority early access.',
